...
<script>
export default {
    name: "DeleteProdModal",
    props: {
        showDeleteModal: Boolean, // Prop to control modal visibility
        product: {
            type: Object,
            required: true,
        },
    ...
    data() {
        return {
            deletedProduct: { ...this.product }, // Initialize deletedProduct with the product prop
        };
    },
    methods: {
        closeModal() {
        ...
        async confirmDelete() {
            try {
                await axios
                    ...
                    .then(() => {
                        this.$emit("delete", this.deletedProduct);
                        this.closeModal();
                    })
                    .catch((error) => {
                        console.error(
